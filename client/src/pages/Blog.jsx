  ...
  return data ? (
    <div className="relative">
      ...
      <div className="text-center mt-20 text-gray-600">
        ...
        <p className="inline-block py-1 px-4 rounded-full mb-6 bg-gray-200 border text-sm border-primary/35 bg-primary/5 font-medium text-primary">
          Yash Goyal
        </p>
      </div>

      <div className="mx-5 max-w-5xl md:mx-auto my-10 mt-6">
        <img src={data.image} className="rounded-3xl mb-5 w-4/5 mx-auto" />
        <div
        ...
        <div className="mt-14 mb-10 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col gap-4">
            {comments.map((item, index) => (
              <div
                key={index}
                className="relative p-4 rounded text-gray-600 bg-primary/2 border border-primary/5 max-w-xl"
              >
